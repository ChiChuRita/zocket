...
## 1. Define a Live Actor

Actors are stateful units with identity, typed methods, state, events, and lifecycle hooks.
...
// Get a typed handle for a specific live actor instance
...
- [Use Cases](/use-cases/) — where Zocket fits best: chats, agents, workflows, rooms, and collaborative state
